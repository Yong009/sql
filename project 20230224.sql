...
SET DEFINE OFF;
Insert into GE.PRICE (CAR_NUMBER,PRICE_PRICE,PRICE_PRICEOIL) values (1,20000,3000);
...
Insert into GE.RENT (RENT_ID,CAR_NUMBER,RENT_DATE,RENT_DISTANCE,RENT_RESERVED,MEMBER_ID) values (2,2,'2023-02-22',40,'R','new1');
...
--------------------------------------------------------
  ...
  ALTER TABLE "GE"."PRICE" ADD FOREIGN KEY ("CAR_NUMBER")
	  REFERENCES "GE"."CAR" ("CAR_NUMBER") ENABLE;
--------------------------------------------------------
